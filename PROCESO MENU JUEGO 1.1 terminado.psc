...
SubProceso Juego3
	...
	Mientras cantaciertos<>cantbarcos Y intentos<>0 Hacer
		...
		Escribir ' '
		Escribir ' '
		Escribir 'Tablero de coordenadas'
	...
	FinSi
	Escribir 'Posiciones de los barcos sin dañar: 1, impactos: 2, disparos perdidos: 3 y vacio: 0' Sin Saltar
	Para i<-1 Hasta tamano Hacer
		Escribir ' '
		Para j<-1 Hasta tamano Hacer
			Escribir matrizataque[i,j],' ' Sin Saltar
...
SubProceso Juego4
	...
	Definir dif, intento, intento_usuario, num  como entero
